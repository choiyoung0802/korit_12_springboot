...
public class CardatabaseApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		appUserRepository.save(new AppUser("user", "$2a$12$ytMn.C.AZaqFkytHhPw1T.mIL9wEMELQIMlsqR8dQU87mUNV9ldb.", "User"));
		appUserRepository.save(new AppUser("admin", "$2a$12$wp29OmpzM62.fEOeFby8WOS6Knrr6r07te2Wgj2P.RxYkrzFNTqQu", "Admin"));
	}
}